    ...
    def getMatrix(self):
        ...
        for y in range(self.height):
            ...
            for x in range(self.width):
                row.append(conv[self.cells[y][x]])
            self.mazeMatrix.append(row)
        self.mazeMatrix[2][1] = 'S'
        self.mazeMatrix[2][2] = 'D'
...
if __name__ == "__main__":
    maze = Maze(50,35)   # (width, height)
    maze.create_maze(3,3)  # start_point
    print(maze)